...
export default function Workbench() {
	...
	// throw new Error("test error"); // Comment out direct error throw, use demo component instead
	...
	return (
		<div className="flex flex-col gap-4 w-full">
			...
			{/* Monthly income + Project progress section */}
